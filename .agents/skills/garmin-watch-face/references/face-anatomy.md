...
- **Measure to lay out rows:** `dc.getTextDimensions(str, font)` or `dc.getTextWidthInPixels(str, font)` to prove text fits its assigned bounds. For custom-font and mockup-matching work, also read `typography-and-layout.md`.
